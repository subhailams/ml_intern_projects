...
# checkpointer = ModelCheckpoint('models/mobilenetv3_small.hdf5', verbose=1, save_best_only=True)
...
with open("models/mobilenetv3_large.json",'w') as json_file:
...
# fig.savefig('logs/log_mobilenetV3_small.png')
