...
base_model=MobileNetV2(alpha=1.0,weights='imagenet',include_top=False) #imports the mobilenet model and discards the last 1000 neuron layer..4
# base_model.summary()
...
checkpointer = ModelCheckpoint('models/mobilenetv2_1.4_moreaugs_2.hdf5', verbose=1, save_best_only=True)
earlystopper = EarlyStopping(monitor='val_loss', patience=15, verbose=1)

log_dir="logs/logs_mobilenetv2_1.4_moreaugs_2/fit/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
with open("models/mobilenetv2_1.4_moreaugs.json",'w') as json_file:
